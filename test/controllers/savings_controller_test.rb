...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference("Saving.count") do
      post savings_url, params: { saving: { label: @saving.label, money: @saving.money, user_id: @saving.user_id } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { label: @saving.label, money: @saving.money, user_id: @saving.user_id } }
